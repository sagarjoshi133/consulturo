  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: __darkBg }}>
      <View style={styles.topBar}>
        <TouchableOpacity onPress={() => (router.canGoBack() ? router.back() : router.replace('/' as any))} style={styles.backBtn} testID="bookings-back">
              ...
              <View key={b.booking_id} style={styles.card}>
                ...
                >
                  ...
                  <View style={styles.cardFoot}>
                    <Ionicons name={(b.mode === 'online' || b.mode === 'video') ? 'logo-whatsapp' : 'medical'} size={14} color={COLORS.primary} />
                    <Text style={styles.cardMode}>{(b.mode === 'online' || b.mode === 'video') ? 'Online' : 'In-person'}</Text>
