...
import StaffBookingsScreen from '../../src/home/staff-bookings-screen';
...
export default function Diseases() {
  ...
  // Role-aware swap: staff see their Bookings list here (the bottom
  // tab labels this slot "Bookings" for staff). Patients keep the
  // original Diseases catalogue.
  const { user } = useAuth();
