...
export default function ProstateVolumeCalc() {
  ...
  const { history, loading, saving, saveScore, removeScore } = useToolHistory('prostate_volume', patientCtx);
      ...
      <ScrollView contentContainerStyle={{ padding: 20 }}>
        ...
        {volume && (
          <View style={styles.result}>
            ...
            <CopyResultButton text={`Prostate volume: ${volume} cc — ${category(volume).label}${patientCtx.patient_name ? ' — Patient: ' + patientCtx.patient_name : ''}`} />
          </View>
        )}
