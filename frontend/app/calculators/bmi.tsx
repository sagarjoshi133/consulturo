...
export default function BmiCalc() {
  ...
  const { history, loading, saving, saveScore, removeScore } = useToolHistory('bmi', patientCtx);
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: __darkBg }}>
      ...
      <ScrollView contentContainerStyle={{ padding: 20, paddingBottom: 60 }}>
        ...
        {bmi && <CopyResultButton text={`BMI: ${bmi} kg/m² — ${cat(bmi).label}${patientCtx.patient_name ? ' — Patient: ' + patientCtx.patient_name : ''}`} />}
