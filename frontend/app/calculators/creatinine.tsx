...
export default function CreatinineTracker() {
  ...
  const { history, loading, saving, saveScore, removeScore } = useToolHistory('creatinine', patientCtx);
    ...
    <View style={{ flex: 1, backgroundColor: __darkBg }}>
      ...
      <ScrollView contentContainerStyle={{ padding: 20, paddingBottom: 60 }}>
        ...
        <View style={styles.card}>
          ...
          {interp && <CopyResultButton text={`Creatinine: ${numeric.toFixed(2)} mg/dL — ${interp.label}${patientCtx.patient_name ? ' — Patient: ' + patientCtx.patient_name : ''}`} />}
        </View>
