...
export default function CrClCalc() {
  ...
  const { history, loading, saving, saveScore, removeScore } = useToolHistory('crcl', patientCtx);
      ...
      <ScrollView contentContainerStyle={{ padding: 20 }}>
        ...
        {crcl && (
          <View style={styles.result}>
            ...
            <CopyResultButton text={`Cockcroft-Gault CrCl: ${crcl} mL/min — ${category(crcl).label}${patientCtx.patient_name ? ' — Patient: ' + patientCtx.patient_name : ''}`} />
          </View>
        )}
