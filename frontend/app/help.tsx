...
export default function HelpScreen() {
  ...
  return (
    <View style={[{ flex: 1, backgroundColor: COLORS.bg }, d.screen]}>
      ...
      >
        {/* Doctor card */}
        <View style={[styles.docCard, d.surface]}>
          {!!c?.doctor_photo_url && (
            <Image source={{ uri: c.doctor_photo_url }} style={styles.docAvatar} />
          )}
          <View style={{ flex: 1 }}>
            <Text style={[styles.docName, d.textP]}>Dr. Sagar Joshi</Text>
            <Text style={[styles.docSub, d.textS]}>Consultant Urologist</Text>
            <Text style={[styles.docSub, d.textS]}>{c?.clinic_name || 'Sterling Hospital'}</Text>
          </View>
        </View>
