...
export type Tier = {
  ...
  canAccessPatientDb: boolean;
  canExportPatientDb: boolean;
...
const EMPTY_TIER: Tier = {
  ...
  canCreateBlog: false,
  canAccessPatientDb: false,
  canExportPatientDb: false,
  ...
  const refresh = useCallback(async () => {
    ...
    try {
      ...
      setTier({
        ...
        canAccessPatientDb: !!data?.can_access_patient_db,
        canExportPatientDb: !!data?.can_export_patient_db,
