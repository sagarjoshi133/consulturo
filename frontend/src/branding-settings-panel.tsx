...
import BrandingPanel from './branding-panel-lazy';
import GoogleReviewSettingsPanel from './google-review-settings';
import FeaturedReviewsAdminPanel from './featured-reviews-admin-panel';
import { useResponsive } from './responsive';

type Category = 'home' | 'branding' | 'rx' | 'reviews' | 'featured';
...
const CATEGORIES: {
  ...
  },
  {
    ...
    icon: 'star',
    color: '#F97316',
    desc: 'Auto-nudge patients to leave a Google review after consultations, Rx & discharge.',
  },
  {
    key: 'featured',
    ...
    icon: 'chatbubbles',
    color: '#D97706',
    desc: 'Curate 5–10 patient testimonials shown on home, /reviews page and prescription footer.',
  },
];
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <View style={{ flex: 1 }}>
        ...
        {cat === 'reviews' && <GoogleReviewSettingsPanel />}
        {cat === 'featured' && <FeaturedReviewsAdminPanel />}
      </View>
    </View>
  );
}
